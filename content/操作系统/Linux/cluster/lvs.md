...
回顾： Linux Cluster： LB/HA/HP LB Cluster： 硬件：Big-IP/Netscaler/A10 软件： 四层：lvs/nginx\(stream\)/haproxy\(mode tcp\) 七层： http: nginx\(http upstream\)/haproxy\(mode http\)/ats/httpd/perlbal/pound/... lvs：Linux Virtual Server vs &lt;--&gt; rs
